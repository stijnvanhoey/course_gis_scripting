...
Notice that you can add any available WMS service to the map, by using the proper linkg to the WMS service. Examples are provided in [this tutorial](https://inbo-tutorials.netlify.com/spatial/wms/).
</div>
